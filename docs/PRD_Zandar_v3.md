...
> **Verzija:** 3.1
> **Status:** Odluke iz Sekcije 48 zatvorene; spremno za razvoj
> **Datum:** 2026-06-07
> **Jezik:** ijekavica
...
Pored postojećeg "Kreiraj sobu" / "Pridruži se preko koda" (privatno), home dobija **"Brza igra"**.

**Flow:**
1. Korisnik klikne "Brza igra".
2. Bira broj igrača (2/3/4) i opcionalno target score (default 21). Može i "bilo koji".
3. Sistem ga preko matchmaker-a stavi za sto **odmah** (vidi Sekciju 38).
4. Prazna sjedišta se popune botovima.
5. Partija kreće bez čekanja.
...
- Korisnik bira playerCount i (opciono) targetScore.
...
### 37.5 Single-player (vježba protiv AI) 🆕

Eksplicitni PvE entry point: home dobija "Vježbaj" / "Igraj protiv AI".

- Korisnik bira broj protivnika (1–3) i tier (ili "auto").
- Sto se popunjava botovima; čovjek je jedini realan igrač i to **zna** — ovdje je svrha vježba, pa se ništa ne prikriva.
- Koristi isti bot engine (Sekcija 40) i iste identitete (Sekcija 39).
- Bez ulaska u zajedničku likvidnost, bez human-over-bot zamjene (čovjek je tu namjerno sam).
- Dobro za onboarding (naučiti pravila bez pritiska) i za brzu partiju kad nema volje za "pravom" igrom.

> Razlika od Quick Play-a: u Quick Play-u su botovi prikriveni (iluzija pune sobe); u single-player-u je transparentno da igraš protiv računara, jer je to poenta moda.
...
- **Sekcija 28 (Backlog):** Must-have += Quick Play matchmaking, Bot engine (3 tiera), Name generator, Bot timing+reactions, **eksplicitni single-player mod (odluka #6)**. Should-have += regulari pool. Could-have += suspected-bot report dugme, sound za bot reactions.
...
### Milestone 9: Quick Play + backfill + single-player
- Entry point, matchmaking (Sekcija 38), human-over-bot prioritet, host bot-fill toggle za privatne sobe.
- 🆕 Single-player "Vježbaj" entry point (Sekcija 37.5) — isti engine, transparentan PvE.
- **DoD:** korisnik klikne "Brza igra" i za < 2s je u partiji koja kreće odmah; "Vježbaj" pokreće PvE sto protiv botova.
...
| 6 | Eksplicitni single-player mod? | **U v3** (Must-have) — vidi 37.5 |

---

**KRAJ DOKUMENTA v3.0**

> Living document. Promjene preko PR-ova sa updated changelog tabelom. Sljedeća verzija: v3.1 nakon Igorovih odluka na Sekciju 48.